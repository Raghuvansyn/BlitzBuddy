  ...
  const handleCreate = async () => {
    try {
      ...
      await createRequest({
        ...
        args: [title, description, category, Number(durationMinutes) || 0, expiresAt],
    ...
    <div className="w-full h-full bg-white rounded-3xl shadow-sm border border-gray-200 flex flex-col p-6 lg:p-8 font-sans">
      ...
      <div className="flex-grow flex flex-col gap-5">
        <div>
          ...
          <input
            type="text"
            placeholder="e.g. Broken package.json"
            className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:outline-none transition-all text-sm text-gray-900 placeholder-gray-400"
            value={title}
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:outline-none transition-all text-sm text-gray-900 placeholder-gray-400 h-24 resize-none"
            value={description}
        ...
        <div className="flex gap-4">
          <div className="w-1/2">
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 text-sm text-gray-900 placeholder-gray-400"
              value={category}
          ...
          <div className="w-1/2">
            ...
            <div className="relative">
              ...
              <input
                type="number"
                placeholder="0.5"
                className="w-full pl-9 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 text-sm text-gray-900 placeholder-gray-400"
                value={bounty}
